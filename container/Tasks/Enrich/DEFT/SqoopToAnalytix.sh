...
sqoop import \
    ...
    --query "select TASKID, OUTPUT_FORMATS from ATLAS_DEFT.T_PRODUCTION_TASK  WHERE UPDATE_TIME > TO_DATE('$1','YYYY-MM-DD HH24:MI:SS')  AND \$CONDITIONS " \
    # --where "UPDATE_TIME > TO_DATE('$1','YYYY-MM-DD HH24:MI:SS') " \
